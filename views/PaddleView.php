    ...
    <body>
        ...
        if (isset($_SESSION['activeUser'])) {
            if (isset($_REQUEST['renting'])) {
                ...
                PaddleController::rentPist($_REQUEST['pist'], $_REQUEST['date'], $_REQUEST['timeInt'], $_REQUEST['timeOut'], $_SESSION['activeUser']->id_user);
            }
            if (isset($_REQUEST['cancel'])) {
                PaddleController::cancelPist($_REQUEST['pist'], $_REQUEST['date'], $_REQUEST['timeInt'], $_REQUEST['timeOut'], $_SESSION['activeUser']->id_user);
            }
            $rents = PaddleController::getAllPaddleRents();
            ?>
            ...
            <div class="container-fluid">
                <div class="row text-center justify-content-center">
                    ...
                    <div class="col-sm-8">
                        <h1>Alquiler de pistas de padel</h1><br>
                        <h2>PISTA 1</h2>
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php
                                $fecha = PaddleController::reOrderDate($dateAcc = date("Y-m-d"));
                                $timeIn = 10;
                                $timeOut = 11;
                                for ($i = 0; $i < 10; $i++) {
                                    ?>
                    ...
                    <div class="col-sm-8">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                $timeIn = 10;
                                $timeOut = 11;
                                $rentsMy = PaddleController::getAllPaddleRentsUser($_SESSION['activeUser']->id_user);
