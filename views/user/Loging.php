...
<div class="container">
    <br><br>
            <h1>Inicio de sesión del centro deportivo de Benameji</h1>
            <form action="../../controllers/loginController.php" method="post">
                <table class="table">
                    <thead>
                        <tr>
                            <th>Correo electrónico: <input type="text" name="email"></th>
                            <th>Contraseña: <input type="password" name="pass"></th>
                            
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td scope="row"><input type="submit" value="Login" name="login"></td>
                            <td></td>
                            <td></td>
                        </tr>
                    </tbody>
                ...
                <br>
                <?php  if(@$_SESSION['usuarioNegativo'] == 1) echo 'Usuario no registrado';  ?>
                <br>
